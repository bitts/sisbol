...
# 
# --------------------------------------------
# Criado em: Qua 20/Abr/2018
# Autor: Asp Of Marcelo Valvassori BITTENCOURT <bittencourt@1cta.eb.mil.br>
# Manutenção: 
# --------------------------------------------
# 
# Propósito Script:  
# Criar script para Backup da aplicação Sisbol para ser agendado no Crontab e realizar backup da aplição em servidor remoto
# 
# Histórico: 
#   v1.0 - Criação de script de backup - feito nas rapido e sem muito cuidado - quem usar => revisar
#
# Licença: GPL
...
enviaParaServidorBackup() {
  echo -ne "--> Enviando Backup do Servidor..." >> $LOG
